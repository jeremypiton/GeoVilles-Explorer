...
(function () {
    ...
    confirmBtn.addEventListener("click", function () {
        ...
        var userSession = JSON.parse(rawSession);
        var rawUsers = localStorage.getItem('gv_users');
        if (rawUsers) {
            var users = JSON.parse(rawUsers);
            var filtered = users.filter(function (u) { return u.email !== userSession.email; });
...
// =============================================================
// 3.2 GESTION UTILISATEUR (UI + LOGOUT)
// =============================================================
(function () {
    var sessionInfo = localStorage.getItem("gv_session");
    if (sessionInfo) {
        var user = JSON.parse(sessionInfo);
